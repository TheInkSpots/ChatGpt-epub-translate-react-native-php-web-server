...
function saveEditTwitchRecord(recordID) {
    ...
    if (new_region != "" && new_district != "" && new_market != "" && new_type != "" && new_contact1 != "" && new_Address_ != "" && new_business_hour != "" ) {
        ...
        $("#statusStr").html(`<div class="alert alert-danger">Input cannot be epmty...</div>`);
    }
    if (new_region == '') {
        $("#statusStr").append(`<div class="alert alert-danger">Please input Region</div>`);
    }
    if (new_district == '') {
        $("#statusStr").append(`<div class="alert alert-danger">Please input District</div>`);
    }
    if (new_market == '') {
        $("#statusStr").append(`<div class="alert alert-danger">Please input Market name</div>`);
    }
    if (new_type == '') {
        $("#statusStr").append(`<div class="alert alert-danger">Please input Market Type</div>`);
    }
    if (new_contact1 == '') {
        $("#statusStr").append(`<div class="alert alert-danger">Please input Contact no.</div>`);
    }
    if (new_nos_stall == '') {
        $("#statusStr").append(`<div class="alert alert-danger">Please input stall amount</div>`);
    }
    if (new_business_hour == '') {
        $("#statusStr").append(`<div class="alert alert-danger">Please input opening hour</div>`);
    }
    if (new_Address_ == '') {
        $("#statusStr").append(`<div class="alert alert-danger">Please input Address</div>`);
    }
...
function goCreate() {
    ...
    if (new_region != "" && new_district != "" && new_market != "" && new_type != "" && new_contact1 != "" && new_Address_ != "" && new_business_hour != "" && new_nos_stall !='') {
        ...
        $("#statusStrCreate").html(`<div class="alert alert-danger ">Input cannot be epmty... </div>`);
    }
    if (new_region == '') {
        $("#statusStrCreate").append(`<div class="alert alert-danger ">Please input Region </div>`);
    }
    if (new_district == '') {
        $("#statusStrCreate").append(`<div class="alert alert-danger ">Please input District </div>`);
    }
    if (new_market == '') {
        $("#statusStrCreate").append(`<div class="alert alert-danger">Please input Market name </div>`);
    }
    if (new_type == '') {
        $("#statusStrCreate").append(`<div class="alert alert-danger">Please input Market Type </div>`);
    }
    if (new_contact1 == '') {
        $("#statusStrCreate").append(`<div class="alert alert-danger">Please input Contact no. </div>`);
    }
    if (new_nos_stall == '') {
        $("#statusStrCreate").append(`<div class="alert alert-danger">Please input stall amount </div>`);
    }
    if (new_business_hour == '') {
        $("#statusStrCreate").append(`<div class="alert alert-danger">Please input opening hour </div>`);
    }
    if (new_Address_ == '') {
        $("#statusStrCreate").append(`<div class="alert alert-danger">Please input Address </div>`);
    }
}
function goDelete() {
    ...
    if (xhttp.readyState == 4) {
        if (xhttp.status == 200) {
           ...
           document.getElementById("btnModalCreate").click();
            ...
            let status = resultArr['success'];
            //let message = resultArray['message'];
            let message = status['message'];
            if (status != null) {
                ele.innerHTML=`<div class="alert alert-success">${message}</div>`;
            } else {
                ele.innerHTML='<img src="/photo/reddot.jpg" width=10px>' +`<div></div>`;
            }
            startSearch('');
        }
    }
...
function showGoogleMap(address){
    console.log('showGoogleM : ' , address);
